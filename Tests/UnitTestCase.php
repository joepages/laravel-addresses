...
namespace Addresses\Tests;

use Addresses\AddressesServiceProvider;
...
abstract class UnitTestCase extends UnitTestCaseBase
{
    ...
    {
        $app['config']->set('addresses.types', ['home', 'work', 'billing', 'shipping', 'mailing', 'other']);
        $app['config']->set('addresses.default_type', 'home');
    }
}
